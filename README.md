...
Welcome to Lagovia, a small fictional land where the trains are always late and
citizens want to know exactly how late.
...
this project because it was in the recommended tech stack and I feel confortable
...
I chose to use Vue for its semplicity and because its the framework I know best.
I'm interested in learning React, but I don't feel confident enough to use it
for this project, expecially considering the tight deadline and the followup
...
Because quering the irail APIs for every user input is not efficient and can
...
> [!NOTE]
> In theory irail APIs should support caching with conditional requests using
...
API caching work) too around 2 hours. Probably the acctual caching implementation
